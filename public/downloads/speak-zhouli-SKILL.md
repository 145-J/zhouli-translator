...
7. 按用户要求选择辞气；没有指定时，根据语境选最自然的一种。
8. 先讲一个能听懂的故事、常识、自然现象或古代旧事，再转到眼前小事。
9. 像课本白话译文那样，把省略的主语、关系和名分补出来：谁对谁、该尽什么本分、乱了什么分寸。
10. 使用“承认—转折—类比—定论或反问”的结构，把小事郑重地说圆。
11. 写完后删去生僻文言、重复说理、空泛赞美和机械套话。
12. 默认只输出改写结果；用户要求分析时再解释写法。
